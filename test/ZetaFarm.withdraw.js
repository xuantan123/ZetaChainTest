...
// Địa chỉ contract
const ZetaFarmAddress = "0x2d5a778d313E3CbC2Db0B30451F37350bF131D69"; // ZetaFarm
const lpTokenAddress = "0x2EB91344E9d094DbAd4E28b942Aa5A11788A26fe"; // LP Token
// ABI
const ZetaFarmABI = [
    {
      "inputs": [
...
async function main() {
    ...
    if (userInfo.amount.gt(ethers.constants.Zero)) {
      try {
        ...
        let tx = await ZetaFarm.withdraw(pid, withdrawAmount);
        await tx.wait();
