...
const ROUTER_ADDRESS = "0x4D837ACc66Eeab20D4f20FeC5Ba39d336A414A28"; // Địa chỉ Router Contract
...
const routerABI = [
    ...
    },
    {
      ...
      "name": "removeLiquidityZETASupportingFeeOnTransferTokens",
      "outputs": [
        {
          "internalType": "uint256",
          "name": "amountZETA",
    ...
    },
    {
      ...
      "name": "removeLiquidityZETAWithPermit",
      "outputs": [
        {
          "internalType": "uint256",
          "name": "amountToken",
    ...
    },
    {
      ...
      "name": "removeLiquidityZETAWithPermitSupportingFeeOnTransferTokens",
      "outputs": [
        {
          "internalType": "uint256",
          "name": "amountZETA",
    ...
    },
    {
      ...
      "name": "swapExactTokensForZETASupportingFeeOnTransferTokens",
      "outputs": [],
      "stateMutability": "nonpayable",
      "type": "function"
    },
    ...
    },
    {
      ...
      "name": "swapExactZETAForTokensSupportingFeeOnTransferTokens",
      "outputs": [],
      "stateMutability": "payable",
      "type": "function"
    },
...
// Add this function to try adding liquidity with native ZETA
async function addLiquidityZETA() {
    console.log("\n💧 Thử thêm thanh khoản với ZETA gốc...");
    ...
    console.log("📌 Chi tiết giao dịch ETH:");
    console.log(`- TOKEN: ${TOKEN_B}`);
    console.log(`- ZTW gửi vào: ${ethers.utils.formatUnits(amountTokenDesired, 18)}`);
    console.log(`- ZETA gửi vào: ${ethers.utils.formatUnits(amountZETA, 18)}`);
    console.log(`- Min ZTW: ${ethers.utils.formatUnits(amountTokenMin, 18)}`);
    console.log(`- Min ZETA: ${ethers.utils.formatUnits(amountZETAMin, 18)}`);
    console.log(`- Người nhận: ${userAddress}`);
...
async function main() {
    ...
    const success1 = await addLiquidityZETA();
